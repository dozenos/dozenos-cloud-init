...
# DozenOS configuration files
CFG_FILE_MAIN = '/opt/vyatta/etc/config/config.boot'
CFG_FILE_DEFAULT = '/usr/share/dozenos/config.boot.default'
...
def handle(name, cfg, cloud, log, _args):
    ...
    commands_list = cfg.get('dozenos_config_commands', [])
    ...
    if commands_list:
        ...
        # Add configuration from the dozenos_config_commands cloud-config section
        try:
